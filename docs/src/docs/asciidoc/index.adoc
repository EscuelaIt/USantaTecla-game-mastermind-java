...
- Modelo/Vista/Presentador con Presentador del Modelo con [black lime-background]*Vista Achicda*
...
[plantuml,mastermindVersion7,svg]
....
...
[plantuml,mastermindViewsVersion7,svg]
....
...
mastermind.views.View *-down-> mastermind.controllers.Controller

....

=== Paquete _mastermind.views.console_

[plantuml,mastermindViewsConsoleVersion7,svg]
...
[plantuml,mastermindViewsGraphicsVersion7,svg]
...
[plantuml,mastermindcontrollersVersion7,svg]
...
mastermind.controllers.Controller -down-> mastermind.controllers.State
...
mastermind.controllers.Logic *-down-> mastermind.controllers.State
mastermind.controllers.Logic *-down-> mastermind.controllers.StateValue
...
class  mastermind.controllers.State{
...
mastermind.controllers.State --> mastermind.controllers.StateValue

class  mastermind.controllers.StateValue{
...
[plantuml,mastermindModelsVersion7,svg]
...
[plantuml,mastermindUtilsVersion7,svg]
